	...
	Repetir
		...
		Segun opcion hacer
			1:
				...
				FinSi
			2:consultar_espacio(E1, E2, E3, E4, E5, E6, E7, E8);
			3:
				...
				Segun opcion hacer
					...
					8: Si E5 <> "Campo vacio" Entonces
						...
						FinSi
				FinSegun
			4: Estados_Usuario(Resultado1, Resultado2, Resultado3, Resultado4, Resultado5, Resultado6, Resultado7, Resultado8, E11, E22, E33, E44, E55, E66, E77, E88);
			5:
...
SubProceso Estados_Usuario( Resultado1, Resultado2, Resultado3, Resultado4, Resultado5, Resultado6, Resultado7, Resultado8, E11, E22, E33, E44, E55, E66, E77, E88 )
...
SubProceso consultar_espacio( E1, E2, E3, E4, E5, E6, E7, E8 )
	Si E1 = "Campo vacio" Entonces
